...
ensure the application is robust, reusable, and maintainable. Change control and issue tracking is managed
...
For those you want to quickly try it out, we currently maintain an instance of \fred hosted at \href{https://scikit-surgeryfred01.ew.r.appspot.com/}{https://scikit-surgeryfred01.ew.r.appspot.com/}. This should be accessible from most modern web browsers.
...
\begin{pythonlisting}{Get \fred by cloning the repository}
...
\begin{pythonlisting}{Install dependencies and run \fred}
